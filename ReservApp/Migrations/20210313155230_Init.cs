        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    reservCount = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    Cause = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    ApprenantsId = table.Column<string>(type: "varchar(255) CHARACTER SET utf8mb4", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Réservations", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Réservations_AspNetUsers_ApprenantsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Réservations_ApprenantsId",
                table: "Réservations",
                column: "ApprenantsId");
        }
